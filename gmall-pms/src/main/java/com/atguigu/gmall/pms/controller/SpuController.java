...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuPageByCategory(PageParamVo pageParamVo,@PathVariable("cId") Long cId){
        PageResultVo pageResultVo = spuService.querySpuPageByCategory(pageParamVo,cId);

...
public class PmsOssController {
    ...
    String accessId = "LTAI4GBKEd97HrUNeqGctc8d"; // 请填写您的AccessKeyId。
    String accessKey = "gWPB2Q05VGmvoKZ1puuRcH97wi7c1u"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "1mygmall"; // 请填写您的 bucketname 。

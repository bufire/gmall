...
public class SkuAttrValueController {
    ...
    //根据sku查询索引属性与值
    @ApiOperation("查询索引属性与值")
    @GetMapping("sku/{skuId}/{categoryId}")
    public ResponseVo<List<SkuAttrValueEntity>> queryAttrValueBySku(@PathVariable Long skuId ,@PathVariable Long categoryId){
        List<SkuAttrValueEntity> list = skuAttrValueService.queryAttrValueBySku(skuId,categoryId);

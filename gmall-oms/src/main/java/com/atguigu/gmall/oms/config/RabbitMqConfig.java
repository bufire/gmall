...
public class RabbitMqConfig {
    ...
    public Binding ttlBinding(){
        return new Binding("order-ttl-queue", DestinationType.QUEUE,"order-exchange","order:create",null);
    }
    ...
    public Binding binding(){
        return new Binding("order-dead-queue", DestinationType.QUEUE,"order-exchange","order.dead",null);
    }
}
